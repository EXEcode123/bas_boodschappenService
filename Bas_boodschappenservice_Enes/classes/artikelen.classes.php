...
class Artikel extends Database{
  ...
  */
	public function showTable($lijst){
		...
		foreach($lijst as $row){
			$txt .= "<tr>";
			$txt .=  "<td><p class='showtable_columns'>id</p>" . $row["art_id"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Omschrijving</p>" . $row["art_oms"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Inkoop prijs</p>" . $row["art_ink"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Verkoop prijs</p>" . $row["art_verk"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Voorraad</p>" . $row["art_voor"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Minimum voorraad</p>" . $row["art_min_voor"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Maximum voorraad</p>" . $row["art_max_voor"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Locatie</p>" . $row["art_loc"] . "</td>";
        	...
        	$txt .=  "<td>";
			$txt .= " 
            <form method='post' action='../artikelen/artikelen_update.php?art_id=$row[art_id]' >       
			...
			$txt .=  "<td>";
			$txt .= " 
            <form method='post' action='../artikelen/artikelen_delete.php?art_id=$row[art_id]' >       
