...
class Klant extends Database{
  ...
  */
	public function showTable($lijst){
		...
		foreach($lijst as $row){
			$txt .= "<tr>";
			$txt .=  "<td><p class='showtable_columns'>Id</p>" . $row["klant_id"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Voornaam</p>" . $row["klant_voornaam"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Achternaam</p>" . $row["klant_achternaam"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Email</p>" . $row["klant_email"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Adres</p>" . $row["klant_adres"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Postcode</p>" . $row["klant_postcode"] . "</td>";
			$txt .=  "<td><p class='showtable_columns'>Woonplaats</p>" . $row["klant_woonplaats"] . "</td>";
			
			//Update
			// Wijzig knopje
        	$txt .=  "<td>";
			$txt .= " 
            <form method='post' action='../klanten/klanten_update.php?klant_id=$row[klant_id]' >       
			...
			$txt .=  "<td>";
			$txt .= " 
            <form method='post' action='../klanten/klanten_delete.php?klant_id=$row[klant_id]' >       
